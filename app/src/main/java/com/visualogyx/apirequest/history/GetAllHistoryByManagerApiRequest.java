...
public class GetAllHistoryByManagerApiRequest extends ApiRequest {

    private Gson gson;
    private String email;

    public GetAllHistoryByManagerApiRequest(Context context, ApiRequest.RequestResponse callback, String email) {
    ...
    public String getRequestUrl() {
        return "/get_manager_history?manager_name=" + email;
    }
