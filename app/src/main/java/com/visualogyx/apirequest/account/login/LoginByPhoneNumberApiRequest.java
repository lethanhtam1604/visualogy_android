...
public class LoginByPhoneNumberApiRequest extends ApiRequest {

    private Gson gson;
    private LoginModel loginModel;

    public LoginByPhoneNumberApiRequest(Context context, RequestResponse callback, LoginModel loginModel) {
    ...
    public String getRequestUrl() {
        return "/login?phone_number=" + loginModel.emailOrPhoneNumber + "&password=" + loginModel.password;
    }
