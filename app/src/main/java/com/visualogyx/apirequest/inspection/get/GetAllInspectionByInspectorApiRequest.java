...
public class GetAllInspectionByInspectorApiRequest extends ApiRequest {

    private Gson gson;
    private String email;

    public GetAllInspectionByInspectorApiRequest(Context context, ApiRequest.RequestResponse callback, String email) {
    ...
    public String getRequestUrl() {
        return "/get_inspector_new_jobs?inspector_name=" + email;
    }
